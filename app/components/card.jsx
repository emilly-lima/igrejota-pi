            ...
            {jogos && jogos.map((item) => (
                <Link href="/game" key={item.Jogo}>
                    <div className='relative '>
                        <div key={item.Jogo} id='carta-super' className="w-[145px] h-[220px] md:w-[200px] md:h-[300px] cursor-pointer items-center flex flex-col gap-2 p-5 aspect-square object-fill ">
